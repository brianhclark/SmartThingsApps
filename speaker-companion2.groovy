...
def mainPage() {
	dynamicPage(name: "mainPage") {
		...
		section{
			input "actionType", "enum", title: "Action?", required: true, defaultValue: "Solemn Bell", options: [
				"Custom Message",
				"Bell 1",
				"Bell 2",
                "Solemn Bell",
...
//	if (allOk) {
		...
		if (oncePerDayOk(lastTime)) {
			if (frequency) {
            	...
            	log.trace "eventHandler().takeAction()"
				takeAction(evt)
			}
		}
		else {
...
private takeAction(evt) {
	...
	log.trace "takeAction() ${evt.name}: ${evt.value}"
...
private loadText() {
	switch ( actionType) {
		...
		case "Bell 2":
			...
			break;
        case "Solemn Bell":
			state.sound = [uri: "http://quinnifer.hopto.org:8383/solemn.mp3", duration: "10"]
			break;
        case "Ding Dong":
			state.sound = [uri: "http://quinnifer.hopto.org:8383/Ding-dong-chime.mp3", duration: "10"]
			break;
        case "Echo Ding":
			state.sound = [uri: "http://quinnifer.hopto.org:8383/echoed-ding.mp3", duration: "10"]
			break;
        case "Birddroid":
			state.sound = [uri: "http://quinnifer.hopto.org:8383/birdroid.mp3", duration: "10"]
			break;
		case "Dogs Barking":
